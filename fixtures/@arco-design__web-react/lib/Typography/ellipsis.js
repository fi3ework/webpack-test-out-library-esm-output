...
var EllipsisComponent = function (baseProps, _) {
    ...
    var _e = __read((0, react_1.useState)(false), 2), overflow = _e[0], setOverflow = _e[1];
    ...
    var computedStyle = (0, react_1.useMemo)(function () {
        if (!expanded) {
            return {
    ...
    var renderMirror = function () {
        ...
        return (react_1.default.createElement(resizeObserver_1.default, { onResize: onResize },
            react_1.default.createElement("div", { className: prefix + "-content-mirror", style: {
                    WebkitBoxOrient: 'vertical',
                    MozBoxOrient: 'vertical',
                    WebkitLineClamp: rows,
    ...
    var renderContent = function () {
        ...
        var content = (react_1.default.createElement("div", { className: (0, classNames_1.default)(prefix + "-content", (_a = {},
                _a[prefix + "-collapsed"] = !expanded,
                _a)), style: computedStyle, title: !tooltipData.tooltip && overflow && !expanded ? text : undefined },
        ...
        if (tooltipData.tooltip) {
            return (react_1.default.createElement(index_1.Tooltip, __assign({ content: text, popupVisible: visible, disabled: !overflow || expanded, triggerProps: {
                ...
                } }, tooltipData.tooltipProps), content));
        }
        return content;
    };
